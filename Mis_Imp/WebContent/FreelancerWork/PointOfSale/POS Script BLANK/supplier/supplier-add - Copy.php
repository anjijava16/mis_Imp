...
<?php
 ...
 <form method="post">
<table border="0">
<tr><td>Supplier Name: *</td><td><input type="text" name="supplier_name" value="<?php echo $supplier_name; ?>" /></td></tr>
...
<tr><td>Phone #</td><td><input type="text" name="supplier_phone" onBlur="this.value=(this.value.match(/^\d{10}/))?this.value.substring(0,2)+' '+this.value.substring(2,6)+' '+this.value.substring(6):this.value"/></td></tr>
<tr><td>Email</td><td><input type="text" name="supplier_email" /></td></tr> 
<tr><td>Website</td><td><input type="text" name="supplier_website" /></td></tr> 
</table>
