...
<?php
 ...
 <table border="0">
   <tr>
     ...
     <td width=200><input type="text" name="supplier_name" value="<?php echo $supplier_name; ?>" class="input2"/></td>
   </tr>
   <tr>
     <td>Address:</td>
     <td><textarea id="supplier_address" name="supplier_address" cols="30" rows="4" style="overflow: auto"/><?php echo $supplier_address ?></textarea></td>
   </tr>
   <tr>
     <td>Phone #:</td>
     <td><input type="text" name="supplier_phone" value="<?php echo $supplier_phone; ?>" onBlur="this.value=(this.value.match(/^\d{10}/))?this.value.substring(0,2)+' '+this.value.substring(2,6)+' '+this.value.substring(6):this.value" class="input2"/></td>
   </tr>
   <tr>
     <td>Email:</td>
     <td><input type="text" name="supplier_email" value="<?php echo $supplier_email; ?>" class="input2"/></td>
   </tr>
   <tr>
     <td>Website:</td>
     <td><input type="text" name="supplier_website" value="<?php echo $supplier_website; ?>" class="input2"/></td>
   </tr>
 </table>

<input type="submit" name="submit" value="Save"> 
</form> 
<p><form action="supplier-delete.php?id=<? echo $id; ?>" method="post"><input type="submit" value="Delete" onclick="return confirm('Are you sure you want to delete this supplier?')" style="background: red;"></form></p>


<h1 style="margin:0 0 15px 5px;">Supplier Items</h1>
