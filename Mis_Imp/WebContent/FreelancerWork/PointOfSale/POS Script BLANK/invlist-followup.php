...
<div id="container">
		...
		<div style="text-align:center">
			<div id="viewwhat">
				...
				<input type="button" name="outstanding" value="View Outstanding" style="width:200px" onClick="document.location.href='invlist-followup.php';" />
			</div>
		...
		<?php
			...
			$query = "	SELECT j.*, c.customer_name, c.customer_tradingas, i.product_name, i.product_supplier
						FROM job_followup j
		...
		<table style="width:100%;">
			...
			<tr style='background:{$rowcolour}' class='item' >
				...
				<td align='left'>
					{$row['customer_name']}
					<br/>
					".(trim($row['customer_tradingas'])!=''?'<b>'.$row['customer_tradingas'].'</b>':'')."
					<br/>
