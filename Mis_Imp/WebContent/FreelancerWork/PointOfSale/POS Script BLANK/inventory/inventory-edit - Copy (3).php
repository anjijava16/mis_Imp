...
function renderForm($id, $product_name, $product_code, $product_alias, $product_category, $product_subcategory, $product_desc, $product_supplier, $product_suppliercode, $product_active, $product_stocked, $product_pricebreak, $product_q1, $product_p1, $product_q2, $product_p2, $product_q3, $product_p3, $product_q4, $product_p4, $product_q5, $product_p5, $product_q6, $product_p6, $product_q7, $product_p7, $product_q8, $product_p8, $product_purchased, $product_soh, $product_reorder, $product_sold, $product_adjusted, $product_weight, $quick_sale, $quick_sale_price, $product_image, $product_type, $product_cost, $freight_cost, $web_sale, $web_special, $member_disc, $follow_up, $has_serial, $error) {?>
	...
	<form method="post">
		...
		<table id="inventable" width=1000px>
			<tr>
				<td width=300>
					Code *<br />
				...
				<td width=300> Member Discount *<br />
			...
			<tr>
			  <td> Name *<br />
			    <input type="text" name="product_name" value="<?=$product_name;?>" class="input1" style="font-weight:bold; width:100%;" /></td>
			  <td> Type *<br />
			  ...
			  <td> S.O.H<br />
			    ...
			    <input type="hidden" name="product_soh" value="<?=$product_soh;?>" /></td>
			  <td>Last Cost per Unit<br />
              <input class="pnq editing money" type="text" name="product_cost" value="$ <?=$product_cost;?>" tabn="19" style="font-weight:bold; width:100%;" /></td>
		  </tr>
			<tr>
			  <td> Category *<br />
			  ...
			  <td colspan="2"><b><u>Quantity &amp; Price List</u></b></td>
		  </tr>
			<tr>
			  <td><span style="float:right;">Quick Sale *</span> Status *<br />
			  ...
			  <td><span style="float:right;">Web Special *</span> Web Sale *<br />
			  ...
			  <td> Base Qty *<br />
			    <input class="pnq editing" type="text" name="product_q1" value="<?=$product_q1;?>" tabn="1" style="font-weight:bold; width:100%;" /></td>
			  <td> Base Price *<br />
			    <input class="pnq editing money" type="text" name="product_p1" value="$ <?=$product_p1;?>" tabn="2" style="font-weight:bold; width:100%;" /></td>
		  </tr>
			<tr>
			  <td> Supplier *<br />
			    <select name='product_supplier' style="width:100%;">
			      ...
			      <? while($nt=mysql_fetch_array($rt)): ?>
			      <option value='<?=$nt["supplier_name"];?>' <?=$nt["supplier_name"]==$product_supplier? " selected":" ";?>>
			        <?=$nt["supplier_name"];?>
		          </option>
			      <? endwhile; ?>
		        </select></td>
			  <td> Supplier Code *<br />
			    <input type="text" name="product_suppliercode" value="<?=$product_suppliercode;?>" class="input1" style="width:100%;" /></td>
			  <td> 2nd Qty<br />
			    <input class="pnq editing" type="text" name="product_q2" value="<?=$product_q2;?>" tabn="3" style="font-weight:bold; width:100%;" /></td>
			  <td> 2nd Price<br />
			    <input class="pnq editing money" type="text" name="product_p2" value="$ <?=$product_p2;?>" tabn="4" style="font-weight:bold; width:100%;" /></td>
		  </tr>
			<tr>
			  <td> Web Image 2nd Lookup<br />
			    <input type="text" name="product_image" value="<?=$product_image;?>" class="input1" style="width:100%;" /></td>
			  <td><span style="float:right;">Request Serial</span> Job Follow Up<br />
			  ...
			  <td> 3rd Qty<br />
			    <input class="pnq editing" type="text" name="product_q3" value="<?=$product_q3;?>" tabn="5" style="font-weight:bold; width:100%;" /></td>
			  <td> 3rd Price<br />
			    <input class="pnq editing money" type="text" name="product_p3" value="$ <?=$product_p3;?>" tabn="6" style="font-weight:bold; width:100%;" /></td>
		  </tr>
			<tr>
				<td colspan="2" rowspan="2">Item Description<br />
                <textarea name="product_desc" rows="5" style="width:100%" placeholder="Write here the product description"><?=$product_desc; ?>
                  </textarea></td>
				<td> 4th Qty<br />
				  <input class="pnq editing" type="text" name="product_q4" value="<?=$product_q4;?>" tabn="7" style="font-weight:bold; width:100%;" /></td>
				<td> 4th Price<br />
				  <input class="pnq editing money" type="text" name="product_p4" value="$ <?=$product_p4;?>" tabn="8" style="font-weight:bold; width:100%;" /></td>
			</tr>
			<tr>
			  <td> 5th Qty<br />
			    <input class="pnq editing" type="text" name="product_q5" value="<?=$product_q5;?>" tabn="9" style="font-weight:bold; width:100%;" /></td>
			  <td> 5th Price<br />
			    <input class="pnq editing money" type="text" name="product_p5" value="$ <?=$product_p5;?>" tabn="10" style="font-weight:bold; width:100%;" /></td>
				<!--
                <td>Stocked *<br />
			...
			<tr>
              ...
              <input type="hidden" name="product_purchased" value="<?=$product_purchased;?>" /></td>
			  <td>Sold<br />
                <input class="pnq editing" type="text" value="<?=$product_sold;?>" disabled="disabled" style="font-weight:bold; width:100%;" />
              <input type="hidden" name="product_sold" value="<?=$product_sold;?>" /></td>
			  <td> 6th Qty<br />
			    <input class="pnq editing" type="text" name="product_q6" value="<?=$product_q6;?>" tabn="11" style="font-weight:bold; width:100%;" /></td>
			  <td> 6th Price<br />
			    <input class="pnq editing money" type="text" name="product_p6" value="$ <?=$product_p6;?>" tabn="12" style="font-weight:bold; width:100%;" /></td>
		  </tr>
			<tr>
			  <td>Adjusted<br />
              ...
              <input type="hidden" name="product_adjusted" value="<?=$product_adjusted;?>" /></td>
			  <td>ReOrder Qty<br />
              <input class="pnq editing" type="text" name="product_reorder" value="<?=$product_reorder;?>" tabn="17" style="font-weight:bold; width:100%;" /></td>
			  <td> 7th Qty<br />
			    <input class="pnq editing" type="text" name="product_q7" value="<?=$product_q7;?>" tabn="13" style="font-weight:bold; width:100%;" /></td>
			  <td> 7th Price<br />
			    <input class="pnq editing money" type="text" name="product_p7" value="$ <?=$product_p7;?>" tabn="14" style="font-weight:bold; width:100%;" /></td>
		  </tr>
			<tr>
			  <td>Weight<br />
              <input class="pnq editing weight" type="text" name="product_weight" value="<?=$product_weight;?> kg" tabn="18" style="font-weight:bold; width:100%;" /></td>
			  <td>Estimated S.O.H Value<br />
              <input class="pnq editing money" type="text" value="<?=($product_type=='S')?'-':'$ '.number_format(floatval($product_cost) * floatval($product_soh), 2);?>" disabled="disabled" style="font-weight:bold; width:100%;" /></td>
				<td> 8th Qty<br />
				  <input class="pnq editing" type="text" name="product_q8" value="<?=$product_q8;?>" tabn="15" style="font-weight:bold; width:100%;" /></td>
				<td> 8th Price<br />
				  <input class="pnq editing money" type="text" name="product_p8" value="$ <?=$product_p8;?>" tabn="16" style="font-weight:bold; width:100%;" /></td>
			</tr>
			<tr>
			  <td colspan="2"><em>To duplicate this item, click the 'CLONE' button then enter the new product number and any other relevant fields then click 'SAVE'</em></td>
