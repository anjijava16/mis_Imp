			...
			$(function(){
				...
				$('#product_code').keydown(function(e){
					...
					if(e.which == 13){
						...
						if($('#prod_list').length == 0) code = $(this).val();
				...
				$("#product_code").bind('keyup', function(e){
					if(e.which == 13){
						$('#qty').select().focus();
						return false;
					}
				...
				$("#supplier").bind('keyup', function(e){
					if(e.which == 13){
						$('#reff').select().focus();
						return false;
					}
				});
				$("#reff").bind('keyup', function(e){
					if(e.which == 13){
						$('#product_code').select().focus();
						return false;
					}
				});
...
?>
	...
	<div>
		<table border="0">
			<tr>
				<td width="40%">
					<div style="font-weight:bold; width:99%;">
						&nbsp;Supplier:
					</div>
					<input type="hidden" id="supplier_id" value="" />
					<input type="text" id="supplier" value="" style="width:95%;" />
				</td>
				<td width="50%">
					<div style="font-weight:bold; width:99%;">
						&nbsp;Reff:
					</div>
					<input type="text" id="reff" value="" style="width:98%;" />
				</td>
				<td width="10%">
					<div style="font-weight:bold; width:99%;">
						&nbsp;Date:
					</div>
					<input type="text" name="date" id="date" value="" style="width:99%;" />
				</td>
			</tr>
		</table>
		<br/>
		<table border="1">
			<thead>
				<tr height="50px" style="background:silver;">
					<th width=" 20px">&nbsp;</th>
					<th width="250px">PRODUCT CODE</th>
			...
			<tbody>
				<tr>
					...
					<td align="center">
						<input type="text" id="product_code" value="" style="width:99%; text-align:center; background:yellow;" />
					</td>
					<td align="center">
						<div id="product_name" style="width:99%;"></div>
						<input type="checkbox" id="payableGST" style="width:auto;" /> <label for="payableGST">GST payable</label> 
						<input type="checkbox" id="inclussiveGST" style="width:auto;" /> <label for="inclussiveGST">GST inclussive</label>
					...
					<td align="center">
						<input type="text" id="qty" value="1" onFocus="if(parseFloat(this.value) == 0) this.value = '';" onBlur="if(this.value == '') this.value = '1'; this.value=parseFloat(this.value);" style="width:99%; text-align:center;" />
					</td> 
					<td align="center">
						$ <input type="text" name="price" id="price" value="0.000" onFocus="if(parseFloat(this.value) == 0) this.value = '';" onBlur="if(this.value == '') this.value = '0'; this.value=parseFloat(this.value).toFixed(3);" style="text-align:center;" />
					</td>
					<td align="center" id="total">$ 0.000</td>
					<td align="center" id="gst">$ 0.000</td>
					<td align="center">
						<button id="add_item" onClick="return false;" style="width:100%;">ADD ITEM</button>
					</td>
				</tr>
			</tbody>
			...
			<tbody>
				<tr>
					...
					<td align="center">-</td> 
					<td align="center">
						$ <input type="text" id="freight" value="0.000" onFocus="if(parseFloat(this.value) == 0) this.value = '';" onBlur="if(this.value == '') this.value = '0'; this.value=parseFloat(this.value).toFixed(3);" style="text-align:center; margin:3px 0; height:16px; font-size:14px;" />
					</td>
					<td align="center" id="total_freight_cost">$ 0.000</td>
					<td align="center" id="gst_freight">$ 0.000</td>
					<td align="center">&nbsp;</td>
				</tr>
			</tbody>
			<tbody>
				<tr>
					...
					<td align="center">-</td> 
					<td align="center">
						$ <input type="text" id="misc" value="0.000"onFocus="if(parseFloat(this.value) == 0) this.value = '';" onBlur="if(this.value == '') this.value = '0'; this.value=parseFloat(this.value).toFixed(3);"  style="text-align:center; margin:3px 0; height:16px; font-size:14px;" />
					</td>
					<td align="center" id="total_misc_cost">$ 0.000</td>
					<td align="center" id="gst_misc">$ 0.000</td>
					<td align="center">&nbsp;</td>
				</tr>
			</tbody>
			<tbody>
				<tr>
					<td colspan="4"></td>
					<th>TOTAL:</th>
					<td align="center" id="result_total">$ 0.000</td>
					<td align="center" id="result_gst">$ 0.000</td>
					<td align="center">
						<button id="save" onClick="return false;" style="width:100%;">SAVE</button>
					</td>
				</tr>
			</tbody>
		</table>
