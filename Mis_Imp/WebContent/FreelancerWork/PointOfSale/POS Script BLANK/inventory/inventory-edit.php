			  	...
			  	<td>
			    	...
			    	<select tabn="-14" id='parentcat' name='category' style="width:100%;">
			      		...
			      		<optgroup>
			      			...
			      			<option class="<?=$nt["category_name"];?>" <?=html_entity_decode($nt["category"])!=html_entity_decode($product_category)?'':'selected="selected"';?> value="<?=$nt["category"];?>"> <?=$nt["category"];?> </option>
			      			<? endwhile; ?>
			      		</optgroup>
		        	</select>
		        </td>
			  	<td>
			    	...
			    	<select tabn="-13" id='childcat' name='product_subcategory' style="width:100%;">
			    		<option value=""> Select Sub Category </option>
			      		...
			      		<optgroup>
			      			<? while($nt=mysql_fetch_array($rt)): ?>
			      			<option class="<?=$nt["category_name"];?>" <?=html_entity_decode($nt["subcategory"])!=html_entity_decode($product_subcategory)?'':'selected="selected"';?> value="<?=$nt["subcategory"];?>"> <?=$nt["subcategory"];?> </option>
			      			<? endwhile; ?>
			      		</optgroup>
		        	</select>
		        </td>
