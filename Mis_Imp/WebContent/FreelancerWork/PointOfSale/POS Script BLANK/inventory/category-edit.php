...
<input type="submit" src='../icons/save.png' name="submit" id="submit" value="">
</form> 
<form action="category-delete.php?id=<? echo $id; ?>" method="post"><input type="submit" value="" id="delete" onclick="return confirm('Are you sure you want to delete this category?')"></form>
