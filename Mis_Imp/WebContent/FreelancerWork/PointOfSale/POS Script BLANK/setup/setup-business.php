...
<input type="button" value="CANCEL" style="width:32%; height:40px; font-weight:bold; background: #AAA; color: #000;" onClick="document.location.href='setup-business.php';">
<input type="submit" name="submit1" id="submit" style="width:32%; height:40px; font-weight:bold; background: #090;" onclick="return submited();" class="pnq" value="SAVE" />
