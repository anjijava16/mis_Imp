...
<tr><td width="150px">Date: *</td><td width="350px" align="right"><input type="text" name="expense_date" value="<?=$expense_date?>"  class="input2"/></td></tr>
<tr><td>Company: *</td><td align="right"><input type="text" id="expense_company" name="expense_company" value="<?=$expense_company?>"  class="input2"/></td></tr>
...
<tr><td>Amount: *</td><td align="right"><input type="text" id="amount" name="expense_amount" value="<?=$expense_amount?>" class="input2" /></td></tr> 
<tr><td>GST payable:</td><td align="right"><input type="checkbox" id="gst_payable"<?=(floatval($expense_gst) > 0 ? ' checked="checked"' : '')?> class="input2" /></td></tr>
<tr><td>GST:</td><td align="right"><input type="text" readonly="readonly" value="0.00" id="gst" name="gst" class="input2" /></td></tr>
<tr>
  <td>Reference: </td><td align="right"><input type="text" name="expense_reff" value="<?=$expense_reff?>" class="input2" /></td></tr>
<tr><td>Notes: *</td><td align="right"><textarea name="expense_notes" rows="5"><?=$expense_notes?></textarea></td></tr>
<tr><td colspan=2 align="right">
<input type="button" value="CANCEL" style="width:32%; height:40px; font-weight:bold; background: #AAA; color: #000;" onClick="document.location.href='expense-list.php';">
