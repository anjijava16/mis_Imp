...
<table border="0">
<tr><td>Company: *</td><td><input type="text" id="expense_company" name="expense_company"></td></tr>
<tr><td>Reference: </td><td><input type="text" name="expense_reff" /></td></tr>
<tr><td>Date: *</td><td><input type="text" name="expense_date" value="<?php echo date("Y/m/d", time()); ?>" id="date1" class="date-pick"/></td></tr>
...
<tr><td>Amount: *</td><td><input type="text" id="amount" name="expense_amount" /></td></tr> 
<tr><td>GST payable:</td><td><input type="checkbox" id="gst_payable" checked="checked" /></td></tr>
<tr><td>GST:</td><td><input type="text" readonly="readonly" value="0.00" id="gst" name="gst" /></td></tr>
<tr><td>Notes: *</td><td><textarea name="expense_notes" rows="5"></textarea></td></tr>
</table>
